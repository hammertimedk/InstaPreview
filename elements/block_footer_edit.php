...
/* Modified Block Edit footer - InstaPreview
 (c) 2014 Arni Johannesson - Kramerica Industries (kramerican.dk)
 MIT License
*/

//Load InstaPreview stuff
Loader::packageElement("instapreview","instapreview");
...
<?php if (!$b->getProxyBlock()) { ?>	
	...
	<!--InstaPreview Button-->
	<a style="float: right;margin-right:10px;" href="javascript:void(0);" class="btn primary instapreview"><i class="icon icon-white icon-search"></i> Preview</a>
	<!--/InstaPreview Button-->
